...
export default function Brand() {
    ...
    return (
        <Link className="position-relative mx-2" to='/cart'>
            ...
            <span className="position-absolute top-50 bg-primary text-white rounded-circle px-1 fw-bold">{cantidadProductos}</span>
        </Link>
    )
}